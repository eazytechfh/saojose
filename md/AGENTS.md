# AGENTS.md — Template para Repositórios

> Copie este arquivo para a raiz de cada repositório e preencha as seções marcadas com [].
> O Codex lê este arquivo automaticamente ao abrir o projeto.
...
- [Liste qualquer bug ou limitação conhecida que o Codex deve estar ciente]
...
Sempre que eu pedir algo, analise se faz sentido vc olhar a pasta, sempre que eu pedir uma alteração verifique se esta de acordo com o que diz nos arquivos da pasta
